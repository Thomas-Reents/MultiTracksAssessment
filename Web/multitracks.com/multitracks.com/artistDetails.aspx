			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<img class="details-banner--hero--img" src="<%=heroURL%>" 
						srcset="<%=heroURL%>, 
						<%=heroURL%> 2x" alt="<%=artistTitle%>">
					</div>
				...
				<nav class="discovery--nav">
					<ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
						...
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="#songSection">Songs</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="#albumSection">Albums</a>
						</li>
				...
				<div class="discovery--container u-container">
							<main class="discovery--section">
								<section class="standard--holder">
									<div id="songSection" class="discovery--section--header">
										<h2>Top Songs</h2>
											...
											<ItemTemplate>
												<li class="song-list--item media-player--row">
													...
													<div class="song-list--item--player-img media-player">
														...
														srcset="<%# Eval("albumImageSong") %> 2x" 
														src="<%# Eval("albumImageSong") %>" alt="<%# Eval("songTitle") %>">
													</div>

													<div class="song-list--item--right">

														<a href="#" class="song-list--item--primary"><%# Eval("songTitle") %></a>
														<a class="song-list--item--secondary"><%# Eval("albumTitleSong") %></a>
								...
								<div class="discovery--space-saver">
									<section class="standard--holder">
										<div id="albumSection" class="discovery--section--header">
											<h2>Albums</h2>
													...
													<ItemTemplate>
														<div class="media-item">
															<a class="media-item--img--link" href="#" tabindex="0">
																<img class="media-item--img" alt="<%#Eval("albumTitle") %>" src="<%#Eval("albumImage") %>" srcset="<%#Eval("albumImage") %>, <%#Eval("albumImage") %> 2x">
																<span class="image-tag">Master</span>
															</a>
															<a class="media-item--title" href="#" tabindex="0"><%#Eval("albumTitle") %></a>
															<a class="media-item--subtitle" href="#" tabindex="0"><%=artistTitle %></a>
														</div>
													</ItemTemplate>
												</asp:Repeater>
											</div><!-- /.grid -->
